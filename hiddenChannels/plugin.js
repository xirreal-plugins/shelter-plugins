(() => {
  ...
  shelter.plugin.scoped.ui.injectCss(`._hiddenChannel_1v3y7_1>div>div>svg>path[d^=M21][d$="5Z"],._hiddenChannel_1v3y7_1>div>div>svg>path[d^=M19][d$="7Z"],._hiddenChannel_1v3y7_1>div>div>svg>path[d^=M17][d$="11Z"],shltr-rroot>svg>path[d^=M21][d$="5Z"],shltr-rroot>svg>path[d^=M19][d$="7Z"]{fill:#ed4245 !important}._hiddenChannel_1v3y7_1>div>div>svg>path[d^=M16][d$="0Z"],._hiddenChannel_1v3y7_1>div>div>svg>path[d^=M18][d$="2Z"],._hiddenChannel_1v3y7_1>div>div>svg>path[d^=M6][d$="14Z"]{fill:#ed4245 !important}._divider_1v3y7_1{width:1px;height:24px;margin:0 8px;-webkit-box-flex:0;-ms-flex:0 0 auto;flex:0 0 auto;background:var(--background-modifier-accent)}._topic_1v3y7_1{-webkit-box-flex:1;-ms-flex:1 1 auto;flex:1 1 auto;position:relative;min-width:0;margin:0 0 0 8px;font-weight:500;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;font-size:14px;line-height:18px;color:var(--header-secondary);padding-top:4px;cursor:pointer}._topicWrapper_1v3y7_1{display:flex;flex-direction:row;-webkit-box-flex:1;-ms-flex:0 0 auto;flex:1 1 auto}._mainBody_1v3y7_1:before{content:"";transform:translate(0px, -1px);height:1px;-webkit-box-shadow:var(--elevation-low);box-shadow:var(--elevation-low);z-index:1;pointer-events:none}._chat_1v3y7_1{display:flex;-webkit-box-flex:1;-ms-flex:0 0 auto;flex:1 1 auto;flex-direction:column;justify-content:center;align-items:center;height:100vh}`);
  var style_default = {
    "hiddenChannel": "_hiddenChannel_1v3y7_1",
    "divider": "_divider_1v3y7_1",
    "topic": "_topic_1v3y7_1",
    "topicWrapper": "_topicWrapper_1v3y7_1",
    "mainBody": "_mainBody_1v3y7_1",
    "chat": "_chat_1v3y7_1"
  };
