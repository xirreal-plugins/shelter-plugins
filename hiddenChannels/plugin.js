...
`);
  var style_default = { "divider": "ccAoOa_divider", "hiddenChannel": "ccAoOa_hiddenChannel", "bold": "ccAoOa_bold", "mainBody": "ccAoOa_mainBody", "topicWrapper": "ccAoOa_topicWrapper", "topicModal": "ccAoOa_topicModal", "topic": "ccAoOa_topic", "headerBar": "ccAoOa_headerBar" };
  ...
  var _tmpl$2 = /* @__PURE__ */ (0, import_web.template)(`<div><div></div><div></div></div>`, 6);
  var {
    ui: {
      openModal,
      ModalBody,
      ...
      get children() {
        return [(0, import_web6.createComponent)(ModalHeader, {
          ...
          get children() {
            ...
            (0, import_web5.insert)(_el$, () => props.channel.topic);
            (0, import_web4.effect)(() => (0, import_web3.className)(_el$, style_default.topicModal));
            return _el$;
          }
        })];
      }
  ...
  function ChannelTopic(props) {
    return props.channel.topic ? (() => {
      ...
      (0, import_web5.insert)(_el$4, () => props.channel.topic);
      (0, import_web4.effect)((_p$) => {
        ...
        _v$2 !== _p$._v$2 && (0, import_web3.className)(_el$3, _p$._v$2 = _v$2);
        _v$3 !== _p$._v$3 && (0, import_web3.className)(_el$4, _p$._v$3 = _v$3);
        return _p$;
      }, {
        _v$: void 0,
        _v$2: void 0,
  ...
  var _tmpl$3 = /* @__PURE__ */ (0, import_web7.template)(`<svg width="24" height="24" viewBox="0 0 24 24" style="margin: 0 8px; color: var(--channel-icon); min-width: 24px;"><title>NSFW Lock</title><path fill="currentColor" fill-rule="evenodd" d="M18.09 1.63c.4-.7 1.43-.7 1.82 0l3.96 6.9c.38.66-.12 1.47-.91 1.47h-7.92c-.79 0-1.3-.81-.91-1.48l3.96-6.9Zm.46 1.87h.9c.3 0 .52.26.5.55l-.22 2.02c-.01.16-.17.26-.33.23a1.92 1.92 0 0 0-.8 0c-.16.03-.32-.07-.33-.23l-.21-2.02a.5.5 0 0 1 .5-.55ZM19 9a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" clip-rule="evenodd"></path><path fill="currentColor" d="M11.45 8c.35 0 .6.35.55.7-.02.2-.02.4 0 .6.04.35-.2.7-.55.7h-1.6l-.67 4h4.97l.26-1.55c.05-.27.31-.45.59-.45h.92c.31 0 .55.28.5.58L16.18 14H20a1 1 0 1 1 0 2h-4.15l-.86 5.16a1 1 0 0 1-1.98-.32l.8-4.84H8.86L8 21.16a1 1 0 0 1-2-.32L6.82 16H3a1 1 0 1 1 0-2h4.15l.67-4H4a1 1 0 0 1 0-2h4.15l.86-5.16a1 1 0 1 1 1.98.32L10.19 8h1.26Z"></path></svg>`, 8);
  var _tmpl$22 = /* @__PURE__ */ (0, import_web7.template)(`<svg title="Lock" width="24" height="24" viewBox="0 0 24 24" style="margin: 0 8px; color: var(--channel-icon); min-width: 24px;"><title>Lock</title><path fill="currentColor" fill-rule="evenodd" d="M16 4h.5v-.5a2.5 2.5 0 0 1 5 0V4h.5a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1Zm4-.5V4h-2v-.5a1 1 0 1 1 2 0Z" clip-rule="evenodd"></path><path fill="currentColor" d="M12.5 8c.28 0 .5.22.5.5V9c0 .1 0 .2.02.31.03.34-.21.69-.56.69H9.85l-.67 4h4.97l.28-1.68c.06-.34.44-.52.77-.43a3 3 0 0 0 .8.11c.27 0 .47.24.43.5l-.25 1.5H20a1 1 0 1 1 0 2h-4.15l-.86 5.16a1 1 0 0 1-1.98-.32l.8-4.84H8.86L8 21.16a1 1 0 0 1-2-.32L6.82 16H3a1 1 0 1 1 0-2h4.15l.67-4H4a1 1 0 1 1 0-2h4.15l.86-5.16a1 1 0 1 1 1.98.32L10.19 8h2.31Z"></path></svg>`, 8);
  function LockedChannelIcon(props) {
    return props.channel.nsfw ? _tmpl$3.cloneNode(true) : _tmpl$22.cloneNode(true);
  }

  // plugins/hiddenChannels/assets/HeaderBar.jsx
  ...
  var Notice_default = (props) => {
    return (() => {
      ...
      _el$.style.setProperty("background", "var(--background-primary)");
      (0, import_web16.insert)(_el$, (0, import_web17.createComponent)(HeaderBar, {
        get children() {
          return [(0, import_web17.createComponent)(LockedChannelIcon, {
            get channel() {
          ...
          }), (0, import_web17.createComponent)(ChannelTopic, {
            get channel() {
              return props.channel;
            }
          })];
      ...
      (0, import_web16.insert)(_el$2, (0, import_web17.createComponent)(Header, {
        get tag() {
      ...
      (0, import_web16.insert)(_el$2, (0, import_web17.createComponent)(Chest, {}), null);
      (0, import_web16.insert)(_el$2, (0, import_web17.createComponent)(Header, {
        get tag() {
      ...
      (0, import_web15.effect)(() => (0, import_web14.className)(_el$2, style_default.mainBody));
      return _el$;
    })();
  };
